export const conversations = [
    ...
    },
    {
        ...
        lastMessage: {
            _id: "2",
            messageType: "text",
            content: "Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there! Hey there!",
            sender: "user2",
        },
        sender: "user4",
        isOnline: true,
